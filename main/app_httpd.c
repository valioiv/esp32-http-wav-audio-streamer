...
static const char *_AUDIO_CONTENT_TYPE = "audio/x-wav";
//static const char *_AUDIO_CONTENT_TYPE = "multipart/x-mixed-replace;boundary=" PART_BOUNDARY;
...
static char wav_header[44] = {
    ...
    0x1,  // Channels
    0x0,  // Channels
    0x80, //0x44, // sampleRate
    0x3e, //0xac, // sampleRate
    0x0,  //0x0,  // sampleRate
    0x0,  //0x0,  // sampleRate
    0x00, //0x88, // (sampleRate * channels * bitsPerSample // 8)
    0x7d, //0x58, // (sampleRate * channels * bitsPerSample // 8)
    0x00, //0x1,  // (sampleRate * channels * bitsPerSample // 8)
    0x00, //0x0,  // (sampleRate * channels * bitsPerSample // 8)
    0x2,  // (channels * bitsPerSample // 8)
    0x0,  // (channels * bitsPerSample // 8)
    0x10, // bitsPerSample
    0x0,  // bitsPerSample
    0x64, // 'd'
    0x61, // 'a'
